...
function validate() {
  ...
  let batteryCapacity = document.forms.solarForm.batteryCapacity.value;
...
function calculateSolar() {
    ...
    // Fetch the selected battery capacity
    let batteryCapacity = document.forms.solarForm.batteryCapacity.value;
    let batteryCost = 0;
    if (batteryCapacity > 0) {
      // Example cost adjustment - you should replace this with actual costs
      batteryCost = batteryCapacity * 200; // Assuming $200 per additional Ah
    }
  
    let totalEstimatedCost = (panelNeed * 1000) + batteryCost; // Adjust according to your pricing model
    ...
    feedback +=
      ...
      panelOutput +
      ' watts per hour</p>';
    feedback += '<p>Total Estimated Cost Including Battery: $' + totalEstimatedCost.toFixed(2) + '</p>'; // Display the total cost
